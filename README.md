...
### Potential Problems
If you have memory issues when attempting to run, setting the stack size to be unlimited should fix the issue, though this should already be resolved after moving most variables to the heap.
